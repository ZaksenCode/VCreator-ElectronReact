...
function Browser(props: any) {
    return (
        <div className="browser">
            ...
            <ComboBox valueName='Модель:' valueDescription='Тег какой-то' boxValues={["block", "none", "X", "aabb" ]} />
            <ComboBox valueName='Вращение:' valueDescription='Тег какой-то' boxValues={["none", "pipe", "pane"]} />
